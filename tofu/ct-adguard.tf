...
# CT 501: Primary AdGuard Home on Cluster Lead (Node: proxmox)
# CT 502: Secondary AdGuard Home on Compute Node (Node: tuxmox)
# ==============================================================================

# ------------------------------------------------------------------------------
# Primary AdGuard Home: CT 501 (Node: proxmox)
# ------------------------------------------------------------------------------
...
# ------------------------------------------------------------------------------
# Secondary AdGuard Home: CT 502 (Node: tuxmox)
# ------------------------------------------------------------------------------
