...
Generate OpenTofu variables and stack environment files (this generates baseline vars and automatically invokes `scripts/instance/bootstrap-instance-secrets.sh` if present):
```bash
